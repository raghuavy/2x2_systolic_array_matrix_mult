...
REM
REM Generated by Vivado on Thu May 21 07:59:21 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_mat_mul_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mat_mul_vlog.prj -log xvlog.log
